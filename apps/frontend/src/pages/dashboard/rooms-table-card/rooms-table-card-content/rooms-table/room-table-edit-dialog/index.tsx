...
import { type AdminUpdateRoomPayload, useAdminUpdateRoom } from "@shared/queries";
...
export default function RoomTableEditDialog({ isOpen, setIsOpen, defaultValues }: RoomTableEditDialogProps) {
		...
		if (isOpen && defaultValues) {
			setForm({
				...
				language: typeof defaultValues.language === "object"
					? String((defaultValues.language as unknown as LanguageDocLeanType)._id)
	...
	const handleUpdate = () => {
		...
		updateMutation.mutate(
			{ apiBaseUrl, id: String(defaultValues._id), data: payload },
			{
				onSuccess: () => {
