...
interface ColumnsOptions {
	onEdit: (language: LanguageDocLeanType) => void;
	onDelete: (language: LanguageDocLeanType) => void;
}

export const getColumns = ({ onEdit, onDelete }: ColumnsOptions): ColumnDef<LanguageDocLeanType>[] =>
	[
		{
			accessorKey: "_id",
			header: "Id",
