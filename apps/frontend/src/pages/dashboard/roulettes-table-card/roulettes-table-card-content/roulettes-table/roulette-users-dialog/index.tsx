...
import { useAdminGetRouletteUsers, useAdminRemoveRouletteUser } from "@shared/queries";
...
export default function RouletteUsersDialog({ rouletteId, open, onOpenChange }: RouletteUsersDialogProps) {
	...
	const { data, isLoading } = useAdminGetRouletteUsers({
		id: rouletteId,
		apiBaseUrl,
