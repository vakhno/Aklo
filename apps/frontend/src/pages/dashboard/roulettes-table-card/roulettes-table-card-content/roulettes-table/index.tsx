...
import { useAdminGetRoulettes } from "@shared/queries";
...
export default function RoulettesTable() {
	...
	const handleEdit = useCallback((roulette: RouletteDocLeanPopulatedType) => {
		setEditingRoulette(roulette);
		setEditDialogOpen(true);
	}, [setEditingRoulette, setEditDialogOpen]);

	const handleDelete = useCallback((roulette: RouletteDocLeanPopulatedType) => {
		setEditingRoulette(roulette);
