import { useGetRoulette } from "@shared/queries";
...
function Participants({ rouletteId }: RoulettePeersProps) {
	...
	const { data: roulette, isPending: isPendingGetRoulette, isError: isErrorGetRoulette } = useGetRoulette({
		apiBaseUrl: import.meta.env.VITE_API_URL,
		id: rouletteId,
		options: { refetchOnWindowFocus: false, refetchOnReconnect: false, refetchOnMount: false, refetchInterval: false, staleTime: Infinity }
	});
